...
export const api = {
  ...
  users: {
    ...
    stats: (id: string) => request<{
      ...
      // Strokes-gained. Putting + around-green derive from typed putt distances;
      // off-tee + approach from GPS shots. Per category is null when there's no
      // data for it; the whole object is null when there's nothing at all.
      sg_per_round: {
